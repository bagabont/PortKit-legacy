...
namespace Portkit.Core.Caching
{
    ...
    public class PortableMemoryCache
    {
        ...
        /// </summary>
        public event TypedEventHandler<object, CacheItem> CacheItemAdded;
        ...
        {
            CacheItemAdded?.Invoke(this, item);
        }

        /// <summary>
        /// Event that occurs when an item is removed from the cache.
        /// </summary>
        public event TypedEventHandler<object, CacheItem> CacheItemRemoved;
        ...
        {
            CacheItemRemoved?.Invoke(this, item);
        }
